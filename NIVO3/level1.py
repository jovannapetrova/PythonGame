...
character_img = pygame.image.load("../pictures/person.png")  # Load character image
...
background_img = pygame.image.load("../pictures/bk.png").convert()
background_img = pygame.transform.smoothscale(background_img, (WIDTH, HEIGHT))

panda_img = pygame.image.load("../pictures/panda.png")  # Заменете го со вистинскиот пат
...
while True:
    ...
    level_hard_btn = draw_button("Ниво: Тешко", LEVEL_BUTTON_X_START + 2 * (LEVEL_BUTTON_WIDTH + LEVEL_BUTTON_SPACING),
                                 LEVEL_BUTTON_Y, LEVEL_BUTTON_WIDTH, LEVEL_BUTTON_HEIGHT,
