...
# Слики и звуци
try:
    background_image = pygame.image.load("../pictures/landscape.png")
    background_image = pygame.transform.scale(background_image, screen.get_size())
except:
    background_image = None

try:
    panda_image = pygame.image.load("../pictures/panda.png")
    panda_image = pygame.transform.scale(panda_image, (80, 80))
except:
    panda_image = None
try:
    panda_image1 = pygame.image.load("../pictures/sittingpanda.png")
    panda_image1 = pygame.transform.scale(panda_image1, (120, 120))
except:
    panda_image1 = None
try:
    star_image = pygame.image.load("../pictures/star.png")
    star_image = pygame.transform.scale(star_image, (40, 40))
except:
    star_image = None

try:
    smiley_image = pygame.image.load("../pictures/smile.png")
    smiley_image = pygame.transform.scale(smiley_image, (40, 40))
except:
    smiley_image = None

try:
    lion_image = pygame.image.load("../pictures/lion.png")
    lion_image = pygame.transform.scale(lion_image, (40, 40))
except:
    lion_image = None

confetti_image = pygame.image.load("../pictures/bravo.png")
...
def draw_challenge_box():
    ...
    pygame.draw.rect(s, COLOR_BUTTON_HIGHLIGHT, (0, 0, challenge_box.width, challenge_box.height), 2, border_radius=12)
...
def draw_objects_area():
    ...
    pygame.draw.rect(s, (*COLOR_TRANSPARENT_BOX[:3], 150), (0, 0, objects_area.width, objects_area.height),
                     border_radius=12)
    pygame.draw.rect(s, COLOR_BUTTON_HIGHLIGHT, (0, 0, objects_area.width, objects_area.height), 2, border_radius=12)
