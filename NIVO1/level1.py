...
import sys
import random
from NIVO1.level2 import start_motorika_level2

def start_motorika_game():
    pygame.init()
    ...
    images = {
        "dough": pygame.image.load("../Pictures-Game1/dough.png"),
        "sauce": pygame.image.load("../Pictures-Game1/tomatosauce.png"),
        "cheese": pygame.image.load("../Pictures-Game1/cheese.png"),
        "veggies": pygame.image.load("../Pictures-Game1/vegetables.png")
    }
    ...
    pizza_stages = [
        pygame.image.load("../Pictures-Game1/doughpizzaarea.png"),
        pygame.image.load("../Pictures-Game1/pizza_1.png"),
        pygame.image.load("../Pictures-Game1/pizza_2.png"),
        pygame.image.load("../Pictures-Game1/pizza_3.png")
    ]
